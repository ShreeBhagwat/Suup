...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CTKFlagPhoneNumber/CTKFlagPhoneNumber.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SACodedTextField/SACodedTextField.framework"
